...
(
    ...
    //PCI Signals
    input PCI_TIPn, BRIDGE_SPACE, CACHE_SPACE, BUFFER_EN, P2A_TIMEOUT, RETRY_CYCLE, //DEVSELn, 
...
wire AD_OUT_EN       = ADDRESS_VALID || (BUFFER_EN && (!CPU_BUSn ^ RnW));
...
wire D_OUT_EN          = (BUFFER_EN && (!CPU_BUSn == RnW));
...
assign PCI_BUF_DIR = ((CPU_BUSn && !BUFFER_EN) || (BUFFER_EN && (!CPU_BUSn == RnW)));
