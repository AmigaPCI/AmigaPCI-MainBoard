...
(
    ...
    output reg CLK_CIA, CIA_TACK_EN, //, CIA_ADDR_LATCH, CIA_EN
...
always @(posedge CLK40) begin
    if (!RESETn) begin
        ...
        if (CIA_START_CYCLE) begin
            ...
            //CIA_START_CYCLE <= (!TSn && CIA_SPACE);
            CIA_START_CYCLE <= (!TSn && (CIA0_SPACE || CIA1_SPACE));
        end
    end
end

//--- Syncronize the CPU signals to the 28M domain. ---
...
//--- Divide by 4 to generate a 7M clock. ---
reg [1:0] DIV_FOUR;
always @(posedge CLK28) begin
    DIV_FOUR <= DIV_FOUR + 1;
end

//--- Detect the negative edge of the 7M clock. ----
